...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] {"CSE","IT","EEE","BBA"};
	private String[] yearString = new String[] {"FIRST","SECOND","THIRD"};
	private String[] subjectFIRSTString = new String[] {"SC","MC"};
	private String[] subjectSECONDString = new String[] {"GT","CN"};
	private String[] subjectTHIRDString = new String[] {"DS","NS"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinneryear.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View view,
				...
				{
					subjectFinal = subjectFIRSTString;
				}
				else if(year.equalsIgnoreCase("te"))
				{
					subjectFinal = subjectSECONDString;
				}
				else if(year.equalsIgnoreCase("be"))
				{
					subjectFinal = subjectTHIRDString;
				}*/
